...
<a href="<?php echo base_url();?>tugas_akhir/rmk/<?php echo $row->MATA_KULIAH;?>"class="waves-effect waves-light btn-flat" style="margin-top:5px; color:#CCC"><i class="mdi-hardware-keyboard-backspace left"></i>back</a>
