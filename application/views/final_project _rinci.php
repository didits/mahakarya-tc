...
<div class="col s12 m2" style=" border-top:#0CF 1px solid">
		<p style="font-weight:800; font-style:italic; color:#06F; font-size:18px"> Keterangan</p>
	...
	<div class="col s12 m8" style="background-color:#fff; border-top:#0CF 1px solid;">
			...
			<p style="font-weight:800; font-style:italic">Video Demo:</p>
<iframe width="100%" height="400" src="<?php echo $row->LINK_VIDEO;?>" frameborder="0" allowfullscreen></iframe>
</iframe>
	</div>
	<div class="col s12 m2" style=" border-top:#0CF 1px solid">
		<p style="font-weight:800; font-style:italic; color:#06F; font-size:18px"> Anggota</p>
		<p style="font-weight:800; font-style:italic">1: <?php echo $row->nrp1;?></p>
		<p style="font-weight:800; font-style:italic">2: <?php echo $row->nrp2;?></p>
		<p style="font-weight:800; font-style:italic">3: <?php echo $row->nrp3;?></p>
		<p style="font-weight:800; font-style:italic">4: <?php echo $row->nrp4;?></p>
		<p style="font-weight:800; font-style:italic">5: <?php echo $row->nrp5;?></p>
		<p style="font-weight:800; font-style:italic">6: <?php echo $row->nrp6;?></p>
	</div>
	<?php }?>
</div>