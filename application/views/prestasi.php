...
<div class="col s12">
      <ul class="tabs">
        <li class="tab col s6"><a class="active" href="#test1">BLOG</a></li>
        <li class="tab col s6"><a href="#test2">DAFTAR PRESTASI</a></li>
      </ul>
    </div>
 <div class="row">
			...
			<div class="row">
				<div class="col s12 m4">
					<div class="icon-block">
						<img src="<?php echo base_url(); ?>assets/blog/tcode.jpg" style="width:100%; height:100%;"/>
					</div>
				</div>
    ...
    <div id="test2" class="col s12">
    	<center><span><b>DATABASE PRESTASI TEKNIK INFORMATIKA ITS</b></span></center>
		...
		<div class="TabbedPanelsContent">
			...
			<div class="row">
				<div class="center">
					...
					<div class="TabbedPanelsContent">
						<center><span><b>DATABASE PRESTAST TEKNIK INFORMATIKA ITS</b></span></center>
						<table class="bordered hoverable">
							<thead>
						      <tr>
						        <th>Nomor</th>
