 <div class="row">
 	<div class="col s12 m2 grid-example side-nav fixed">
 		<h5 class="center" style="padding-top:15px; background-color:#3b424b">KL</h5>
 		<ul>
 			<li class="no-padding">
 	...
 	<div class="col s12 m10 grid-example">
 		<div class="section">
 			<h5 class="center" style="padding-top:15px; background-color:#3b424b">KARYA LOMBA VIDEOS</h5>
			<!--   Icon Section   -->
